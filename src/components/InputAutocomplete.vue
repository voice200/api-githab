<template>
  <div class="autocomplete">
    <label class="autocomplete_label" for="url">Enter the full path to the repository as 'https://github.com/owner/repository' or in the format
      “user/repository” or “org/repository”</label>
